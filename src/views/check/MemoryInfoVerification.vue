...
<div>
        <el-row>
                            ...
                            <el-card class="cardx" shadow="hover" :body-style="{ padding: '0px' }">
                                <div class="grid-content grid-con-3">
                                    ...
                                    <div class="grid-cont-right">
                                        <div class="grid-num">内存信息与MES对比结果</div>
         ...
         <el-row type="flex" justify="center" gutter="200" class="row-bg">
           <el-col span="12">
             <el-card class="grid-content bg-purple nav-title nb">内存信息<i class="el-icon-loading"></i></el-card>
           </el-col>
         <el-col span="12">
          ...
          <el-col span="12">
            <el-card shadow="hover" class="nb">
              <el-form ref="formRef" :model="form" label-width="80px" >
                        ...
                        <el-form-item label="内存型号:" class="zhiti1" prop="name">
                            <el-input v-model="form.name"></el-input>
                        </el-form-item>
                        <el-form-item label="内存容量:" class="zhiti1" prop="region">
                            <el-input v-model="form.region"></el-input>
                        </el-form-item>
                        <el-form-item label="内存数量:" class="zhiti1" prop="hexing">
                            <el-input v-model="form.hexing"></el-input>
                        </el-form-item>
                        <el-form-item label="内存频率:" class="zhiti1" prop="xingcheng">
                            <el-input v-model="form.xiangcheng"></el-input>
                        </el-form-item>
                        <el-form-item label="内存厂商:" class="zhiti1" prop="sudu">
