<template>
    <div>
        <el-row>
                ...
                <el-card class="cardx" shadow="hover" :body-style="{ padding: '0px' }">
                    <div class="grid-content grid-con-3">
                        ...
                        <div class="grid-cont-right">
                            <div >
                                <span class="grid-num">内存ECC检查</span>
                            </div>
                            <div>
            ...
            <el-row type="flex">
                <el-col :span="17" :offset="3" v-loading="loading"><el-card class="grid-content2 bg-purple nb">{{mem_ecc_infor.cmd_infor}}</el-card></el-col>
            </el-row>
...
<script>
import { getMemEcc, getStopStress } from '../../api/api.js';
export default {    
    inject:['reload'],
    ...
    methods: {
        start(){
            if(this.qqt){
                this.loading = true 
                getMemEcc().then(res => {
                    this.MemEcc = res.data
                    this.mem_ecc_infor = this.MemEcc.mem_ecc
                    this.status = this.MemEcc.status
                    if(this.status=='PASS'){
                        this.loading = false
